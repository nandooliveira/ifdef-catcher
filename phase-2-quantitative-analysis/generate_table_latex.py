...
def create_table():
    ...
    for projectname in map:
        ...
        table += projectname + ' & ' + map[projectname][first_version]['#LOC'] + ' & ' + \
            map[projectname][second_version]['#LOC'] + ' & \\fbox{{\\color{' + color_LOC + '} ' + \
            str(calc_LOC) \
            + '}}  & ' + map[projectname][first_version]['#AA'] + ' & ' + \
            map[projectname][second_version]['#AA'] + ' & \\fbox{{\\color{' + color_AA + '} ' +\
            str(calc_AA)  + \
            '}} & ' + map[projectname][first_version]['%disciplined'] + '\\% & ' + \
            map[projectname][second_version]['%disciplined'] + '\\% & \\fbox{{\\color{' + color_disc + '} ' + \
            "{:.2f}".format(calc_disc) + \
            '\\%}} \\\\ \n'
